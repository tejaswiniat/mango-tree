...
mango1 =  new Mango(random(250,450),200,70);  
mango2 =  new Mango(random(200,550),random(150,300),70); 
mango3 =  new Mango(random(100,400),random(100,350),70);  
mango4 =  new Mango(random(250,500),random(150,250),70); 
mango5 =  new Mango(random(200,550),random(100,350),70); 
...
//	World.add(world, boyBody); 
	elastic = new Elastic(stone.body,{x:935,y:420}); 
